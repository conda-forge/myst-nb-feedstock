...
Once the `conda-forge` channel has been enabled, `myst-nb` can be installed with:

```
conda install myst-nb
```

It is possible to list all of the versions of `myst-nb` available on your platform with:
